...
Rather than adding features, the focus is on:
...
* Controlled page entry with a custom preloader
...
A Python-based system fingerprinting and network reconnaissance tool:
